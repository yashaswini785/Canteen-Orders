...
import static com.lakj.comspace.simpletextclient.SlimpleTextClientActivity.tbl_no;
   ...
   static  String period;
    ...
    public void show_Order() {
        ...
        tv.setText("" + temp_order_view);
            ...
            TextView tv1 = (TextView) findViewById(R.id.oname);
            tv1.setText("order Registered" + " " + (finalize_order.name));


        String  p= period.toString();
        TextView tv2= (TextView) findViewById(R.id.otime);
        tv2.setText("you can pick your order @" + " " + (finalize_order.period));
    ...
    builder.setMessage("Are you sure you want to confirm this order?")
            ...
            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                      ...
                      messsage = "Order:" + (tbl_no)+ "|"  + fin_order_string + "|" + Integer.toString(all_total)+"|"+personal_preferances;
